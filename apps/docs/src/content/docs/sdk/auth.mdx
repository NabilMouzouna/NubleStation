...
<CardGrid>
  <LinkCard title="Identity — Auth Service" href="/docs/services/auth" description="The server-side service: routes, sessions, authorization, avatars." />
  <LinkCard title="@nublestation/vault" href="/docs/sdk/storage" description="The file storage SDK — same factory shape." />
</CardGrid>
